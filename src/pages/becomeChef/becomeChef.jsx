...
export const BecomeChef = () => {
  ...
  return (
    <div className={classNames(style.becomeChef, mainStyle.container)}>
       <BigContent
    img={imgurl}>
      <TitleComponent
       title= {'Become A Chef'}
      ...
      <ul>
       ...
       <Button className={mainStyle.btnFill}>Become a Chef</Button>
       <SmallContent
